...
~\\
\activities{Preparatory work will consist of testing parametric methods for seeing-convolved 2D fitting of the galaxy light distribution on precursor surveys (e.g. Subaru or KiDS) and on simulated LSST images, with the aim of providing viable tools for automatic image masking, catalogue extraction, source classification, and 2D galaxy fitting
in Level 3 datasets. 
