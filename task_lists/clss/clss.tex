...
Exploration of optimal filter methods could improve cluster identification
...
~
\begin{enumerate}
\item Guidance for LSST galaxy pipelines to include all the necessary information for measurements of the correlation function and related statistics to take place once LSST data is available. This deliverable requires the engineering of ancillary products such as masks and maps of completeness as a function of galaxy properties.
...
\label{task:clss:los}
\motivation{
Lines-of-sight through galaxy clusters and groups rank among the 
most challenging situations for measuring reliable photometric
...
basic L2 LSST photometry of objects within a cone centered on the
