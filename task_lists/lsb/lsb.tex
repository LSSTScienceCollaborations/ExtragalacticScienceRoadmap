...
New methods of detecting LSB objects will be engineered, including pixel clustering methods and the labeling of pixels with certain properties, i.e., surface brightness level, SED shape, and proximity to other similar pixels. We will trian our methods on other currently available data sets (KIDS, CFHT etc). These analyses will further
